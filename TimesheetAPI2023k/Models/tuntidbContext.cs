...
namespace TimesheetAPI2023k.Models
{
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=DESKTOP-05S0KN9\\SQLEXPRESS;Database=tuntidb;Trusted_Connection=True;");
               
                //Server = tcp:duuniserver.database.windows.net,1433; Initial Catalog = tuntidb; Persist Security Info = False; User ID = sirensimo; Password ={ your_password}; MultipleActiveResultSets = False; Encrypt = True; TrustServerCertificate = False; Connection Timeout = 30;
